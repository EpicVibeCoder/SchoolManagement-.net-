...
export default function TeacherAssignmentsPage() {
  ...
  const load = async () => {
    ...
    setError(null);
    try {
      const [assignmentsData, teacherAssignmentsData] = await Promise.all([
        get<AssignmentDto[]>("/api/assignments"),
        get<TeacherAssignmentDto[]>(`/api/teacher-assignments?teacherId=${user.id}`),
      ]);
        ...
        <div className="sm-card mb-6 p-5">
          ...
          <form onSubmit={handleSubmit(onCreate)} className="mt-4 grid gap-3 sm:grid-cols-2" noValidate>
            ...
            <div className="sm:col-span-2">
              <label className="sm-label" htmlFor="title">Title</label>
            ...
            <div className="sm:col-span-2">
              <label className="sm-label" htmlFor="description">Description</label>
            ...
            <div>
              <label className="sm-label" htmlFor="classId">Class</label>
            ...
            <div>
              <label className="sm-label" htmlFor="subjectId">Subject</label>
            ...
            <div>
              <label className="sm-label" htmlFor="deadline">Deadline</label>
            ...
            <div>
              <label className="sm-label" htmlFor="maxMarks">Max marks</label>
            ...
            <tbody>
              {assignments.map((a) => (
                <tr key={a.id}>
                  ...
                  <td>{a.className} · {a.subjectName}</td>
