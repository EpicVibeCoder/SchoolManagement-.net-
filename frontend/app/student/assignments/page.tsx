        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {assignments.map((a) => (
            <Link
              ...
              className="sm-card block p-5 transition hover:border-[var(--color-primary-soft)]"
            >
          ...
          {assignments.length === 0 && (
            <div className="sm-card p-8 text-center text-sm text-[var(--color-ink-soft)] sm:col-span-2 lg:col-span-3">
