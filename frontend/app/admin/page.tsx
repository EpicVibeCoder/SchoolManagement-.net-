            ...
            <div>
                  ...
                  <div className="mt-8 sm-card p-6">
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                              <Link href="/admin/users" className="sm-btn sm-btn-secondary">
                                    Manage Users
                              </Link>
                              <Link href="/admin/classes" className="sm-btn sm-btn-secondary">
                                    Manage Classes
                              </Link>
                              <Link href="/admin/subjects" className="sm-btn sm-btn-secondary">
                                    Manage Subjects
                              </Link>
                              <Link href="/admin/teacher-assignments" className="sm-btn sm-btn-secondary">
                                    Teacher Assignments
                              </Link>
                              <Link href="/admin/enrollments" className="sm-btn sm-btn-secondary">
                                    Enrollments
                              </Link>
                              <Link href="/admin/settings" className="sm-btn sm-btn-secondary">
                                    Settings
                              </Link>
                        </div>
                  </div>
