        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
                  ...
                  <Link
                    ...
                    className={`rounded-md px-3 py-1.5 text-sm font-medium transition ${
                      active
                        ...
                        : "text-[var(--color-ink-soft)] hover:bg-[var(--color-bg-soft)] hover:text-[var(--color-primary-dark)]"
                    }`}
                  >
                    {link.label}
                  </Link>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="hidden text-right sm:block">
              <p className="text-sm font-semibold leading-tight text-[var(--color-primary-dark)]">
                {user?.fullName}
              </p>
              <p className="text-xs leading-tight text-[var(--color-ink-soft)]">
            ...
            <button
              type="button"
              className="flex h-9 w-9 items-center justify-center rounded-md border border-[var(--color-border)] lg:hidden"
          ...
          <nav className="border-t border-[var(--color-border)] px-4 py-2 lg:hidden">
            <div className="flex flex-col gap-1">
              ...
              <button
                ...
                className="mt-1 rounded-md px-3 py-2 text-left text-sm font-medium text-[var(--color-danger)] hover:bg-[var(--color-danger-bg)]"
              >
                Log out
              </button>
            </div>
